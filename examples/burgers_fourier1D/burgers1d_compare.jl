...
# burgers1d_train_CINR(latent, modeldir_CINR, datafile; device)
# burgers1d_train_SNFW(latent, modeldir_SNFW, datafile; device)
# burgers1d_train_SNFL(latent, modeldir_SNFL, datafile; device)
