...
modeldir_SN0 = joinpath(@__DIR__, "model_SN0$(l0)") # us (Lipschitz)
...
grid = (256,)
casename = "ks1d"
modeldirs = (; modeldir_PCA, modeldir_CAE, modeldir_SNL, modeldir_SNW) #, modeldir_SN0)
labels = ("POD ($(l_pca) modes)", "CAE", "SNFL (ours)", "SNFW (ours)") #, "Ablation")
